...
<div id="Updatepicture" class="modal fade" role="dialog">
  <div class="modal-dialog" style="float:right;width:20%">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background-color:#346b31;">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
			...
			<div class="col-md-4 span_8">
				<div class="activity_box">
			       ...
			       $retrieve = mysqli_query($db,$sqlmember);
	                 ...
	                 {
                       $title=$found['Title'];$firstname=$found['Firstname'];$surname=$found['Surname'];$phone=$found['Phone'];$ids=$found['id'];$online=$found['Online'];
      ...
      <a class='example-image-link' href='admin/images/$profile' data-lightbox='example-1'>$pic</a></div>
							<div class='col-xs-7 activity-desc'>
								<h5><a href='#'>$firstname $surname</a></h5>
								<p>Last Seen:$lseen</p>
							</div>
